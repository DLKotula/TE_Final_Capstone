...
<div id="card-page">
	...
	<div class="main-content">
		...
		<div id="sorting-options">
			...
			<ul>
				<li>
					<a href="<c:url value="/products?sortOrder=PriceLowToHigh"/>">
						Price - Low to High
					</a>
				</li>
				<li>
					<a href="<c:url value="/products?sortOrder=PriceHighToLow"/>">
						Price - High to Low</a>
					</li>
				<li>
					<a href="<c:url value="/products?sortOrder=RatingHighToLow"/>">
						Rating - High to Low
					</a>
				</li>
			</ul>
